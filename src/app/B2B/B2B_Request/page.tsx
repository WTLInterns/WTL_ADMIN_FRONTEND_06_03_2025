...
// const RequestB2B = () => {
//   // Replacing "vendorName" with "companyName"
//   const [companyName, setCompanyName] = useState('');
//   // Replacing "email" with "businessEmail"
...
//     // Prepare template parameters to match your EmailJS placeholders
//     const templateParams = {
//       company_name: companyName,     // {{company_name}}
//       b2b_id: id,             // {{b2b_id}} (Hard-coded for now)
...
const RequestB2B = () => {
  ...
  const handleBusinessEmailBlur = async () => {
    ...
    try {
      const response = await fetch(`https://worldtriplink.com/b2b/email/${businessEmail}`);
      if (response.ok) {
